    ...
    return (
        <div>
            ...
            >
                ...
                {sellForm === "List" && <ListForm />}
            </Modal>
        </div>
    )
}

const AuctionForm = ({ loading, handleAuctionFormSubmit }) => {
            ...
            >
                <Form.Item
                    ...
                    label={
                        <span>
                            Contract Address&nbsp;
                            <Tooltip
                                title="Select the Contract Address which holds your NFT"
                                placement="right"
                            >
                                <InfoCircleOutlined />
                            </Tooltip>
                ...
                <Form.Item
                    ...
                    label={
                        <span>
                            Token ID&nbsp;
                            <Tooltip title="Select the Token ID of your NFT" placement="right">
                                <InfoCircleOutlined />
                            </Tooltip>
                        </span>
                    }
                ...
                <Form.Item name="dateRange" label="Auction Length" {...rangeConfig}>
...
//         <div>
//             <Modal
//                 title={`Create NFT for Auction`}
//                 open={setSellForm === "Auction"}
//                 onCancel={setSellForm === ""}
//                 // onOk={() => list(nftToSend, price)}
//                 // okText="List"
//                 footer={[
